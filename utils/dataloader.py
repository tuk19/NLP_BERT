...
def get_chABSA_DataLoaders_and_TEXT(max_length=256, batch_size=32):
    ...
    # 出力保存用のテキストファイル
    path_w = '/content/drive/My Drive/Colab Notebooks/my_bert/data/negaposi.txt'
    ...
    random.seed(1234)
    # 単語分割用のTokenizerを用意
    tokenizer_bert = BertTokenizer(vocab_file="/content/drive/My Drive/Colab Notebooks/my_bert/vocab/vocab.txt", do_lower_case=False)
    ...
    train_val_ds, test_ds = torchtext.data.TabularDataset.splits(
        path="/content/drive/My Drive/Colab Notebooks/my_bert/data", train='train_bin.tsv',
    ...
    """
    train_val_ds, test_ds = torchtext.data.TabularDataset.splits(
        path="/content/drive/My Drive/Colab Notebooks/my_bert/data", train='train_negaposhi.tsv',
        test='test_negaposhi.tsv', format='tsv',
        fields=[('Text', TEXT), ('Label', LABEL)])
    
    """
    train_val_ds, test_ds = torchtext.data.TabularDataset.splits(
        path="/content/drive/My Drive/Colab Notebooks/my_bert/data", train='train.tsv',
