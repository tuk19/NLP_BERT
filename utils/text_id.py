...
class BertWordPieceTokenizer(BaseTokenizer):
    ...
    def __init__(
        self,
        vocab_file: Optional[str] = '/content/drive/My Drive/Colab Notebooks/my_bert/vocab/vocab.txt',
...
PATH_VOCAB = '/content/drive/My Drive/Colab Notebooks/my_bert/vocab/vocab.txt'    # 1行に1語彙が書かれたtxtファイル
jpp = Juman()
