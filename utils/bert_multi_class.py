...
def get_config(file_path):
    ...
    config_file = "/content/drive/My Drive/Colab Notebooks/my_bert/utils/bert_config.json"  # file_path  
...
def load_vocab(vocab_file):
    ...
    with open("/content/drive/My Drive/Colab Notebooks/my_bert/vocab/vocab.txt", "r", encoding="utf-8") as reader: #vocab_file
        while True:
...
class BertTokenizer(object):
    ...
    def __init__(self, vocab_file, do_lower_case=False):   # 濁点が落ちるためFalseに設定（英語と異なる点）
        ...
        # ボキャブラリーのロード
        self.vocab, self.ids_to_tokens = load_vocab("/content/drive/My Drive/Colab Notebooks/my_bert/vocab/vocab.txt")
...
class BertForchABSA(nn.Module):
    ...
    def __init__(self, net_bert):
        ...
        # self.cls = nn.Linear(in_features=256, out_features=14)
        self.cls = nn.Linear(in_features=32, out_features=6)
