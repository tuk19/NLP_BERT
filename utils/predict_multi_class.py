...
def mk_html(input, preds, normlized_weights, TEXT):
    ...
    if pred == 0: 
        ...
        pred_str = "Runny_nose"   # 鼻水
    elif pred == 3:
        pred_str = "Fever"   # 熱
    elif pred == 4:
        pred_str = "Sore_throat"   # 咽頭痛
    elif pred == 5:
        pred_str = "cough_&_Runny_nose"   # 咳＆鼻水
    elif pred == 6:
        pred_str = "cough_&_Fever"   # 咳＆発熱
    elif pred == 7:
        pred_str = "asthma"   # 喘息
    elif pred == 8:
        pred_str = "cold"   # 風邪
    elif pred == 9:
        pred_str = "headache"   # 頭痛
    elif pred == 10:
        pred_str = "cough_&_headache"   # 咳と頭痛
    elif pred == 11:
        pred_str = "Runny_nose_&_headache"   # 鼻水と頭痛
    elif pred == 12:
        pred_str = "Sputum"   # 痰
    elif pred == 13:
        pred_str = "See_doctor"   # 受診
    """
    ...
    for i in range(12):
        ...
        for word, attn in zip(sentence, attens):
            ...
            if tokenizer_bert.convert_ids_to_tokens([word.cpu().numpy().tolist()])[0] == "[SEP]":
                break
